    ...
    public class Post : IPost
    {
        ...
        public int InsertPost(PostInfo postinfo)
        {
            ...
            SqlParameter[] prams = { 
                                ...
                                SqlHelper.MakeInParam("@CategoryId",SqlDbType.Int,4,postinfo.CategoryId),
								SqlHelper.MakeInParam("@Title",SqlDbType.VarChar,255,postinfo.Title),
								SqlHelper.MakeInParam("@Summary",SqlDbType.VarChar,500,postinfo.Summary),
								SqlHelper.MakeInParam("@Content",SqlDbType.Text,2147483646,postinfo.Content),
								SqlHelper.MakeInParam("@Slug",SqlDbType.VarChar,255,postinfo.Slug),
								SqlHelper.MakeInParam("@UserId",SqlDbType.Int,4,postinfo.UserId),
								SqlHelper.MakeInParam("@CommentStatus",SqlDbType.Int,4,postinfo.CommentStatus),
								SqlHelper.MakeInParam("@CommentCount",SqlDbType.Int,4,postinfo.CommentCount),
								SqlHelper.MakeInParam("@ViewCount",SqlDbType.Int,4,postinfo.ViewCount),
								SqlHelper.MakeInParam("@Tag",SqlDbType.VarChar,255,postinfo.Tag),
                                SqlHelper.MakeInParam("@UrlFormat",SqlDbType.Int,4,postinfo.UrlFormat),
                                SqlHelper.MakeInParam("@Template",SqlDbType.VarChar,50,postinfo.Template ),
                                SqlHelper.MakeInParam("@Recommend",SqlDbType.Int,4,postinfo.Recommend),
								SqlHelper.MakeInParam("@Status",SqlDbType.Int,4,postinfo.Status),
                                SqlHelper.MakeInParam("@TopStatus",SqlDbType.Int,4,postinfo.TopStatus),
                                SqlHelper.MakeInParam("@HideStatus",SqlDbType.Int,4,postinfo.HideStatus),
								SqlHelper.MakeInParam("@CreateDate",SqlDbType.DateTime,8,postinfo.CreateDate),
								SqlHelper.MakeInParam("@UpdateDate",SqlDbType.DateTime,8,postinfo.UpdateDate)
							};
           int newId= SqlHelper.ExecuteNonQuery(CommandType.Text, cmdText, prams);
        ...
        public int UpdatePost(PostInfo postinfo)
        {
            ...
            //    SqlHelper.ExecuteNonQuery(string.Format("update [loachs_terms] set [count]=[count]-1 where [termid]={0}", oldPost.CategoryId));

            //    SqlHelper.ExecuteNonQuery(string.Format("update [loachs_terms] set [count]=[count]+1 where [termid]={0}", postinfo.CategoryId));
            ...
            SqlParameter[] prams = { 
                                ...
                                SqlHelper.MakeInParam("@CategoryId",SqlDbType.Int,4,postinfo.CategoryId),
								SqlHelper.MakeInParam("@Title",SqlDbType.VarChar,255,postinfo.Title),
								SqlHelper.MakeInParam("@Summary",SqlDbType.VarChar,0,postinfo.Summary),
								SqlHelper.MakeInParam("@Content",SqlDbType.Text,2147483646,postinfo.Content),
								SqlHelper.MakeInParam("@Slug",SqlDbType.VarChar,255,postinfo.Slug),
								SqlHelper.MakeInParam("@UserId",SqlDbType.Int,4,postinfo.UserId),
								SqlHelper.MakeInParam("@CommentStatus",SqlDbType.Int,1,postinfo.CommentStatus),
								SqlHelper.MakeInParam("@CommentCount",SqlDbType.Int,4,postinfo.CommentCount),
								SqlHelper.MakeInParam("@ViewCount",SqlDbType.Int,4,postinfo.ViewCount),
								SqlHelper.MakeInParam("@Tag",SqlDbType.VarChar,255,postinfo.Tag),
                                SqlHelper.MakeInParam("@UrlFormat",SqlDbType.Int,1,postinfo.UrlFormat),
                                SqlHelper.MakeInParam("@Template",SqlDbType.VarChar,50,postinfo.Template ),
                                SqlHelper.MakeInParam("@Recommend",SqlDbType.Int,1,postinfo.Recommend),
								SqlHelper.MakeInParam("@Status",SqlDbType.Int,1,postinfo.Status),
                                SqlHelper.MakeInParam("@TopStatus",SqlDbType.Int,1,postinfo.TopStatus),
                                SqlHelper.MakeInParam("@HideStatus",SqlDbType.Int,1,postinfo.HideStatus),
								SqlHelper.MakeInParam("@CreateDate",SqlDbType.DateTime,8,postinfo.CreateDate),
								SqlHelper.MakeInParam("@UpdateDate",SqlDbType.DateTime,8,postinfo.UpdateDate),
                                SqlHelper.MakeInParam("@PostId",SqlDbType.Int,4,postinfo.PostId),
							};
        ...
        public int DeletePost(int postid)
        {
            ...
            int result = SqlHelper.ExecuteNonQuery(CommandType.Text, cmdText, prams);



            //if (oldPost != null)
            //{
            //    SqlHelper.ExecuteNonQuery(string.Format("update [loachs_users] set [postcount]=[postcount]-1 where [userid]={0}", oldPost.UserId));
            //    SqlHelper.ExecuteNonQuery("update [loachs_sites] set [postcount]=[postcount]-1");
            //    SqlHelper.ExecuteNonQuery(string.Format("update [loachs_terms] set [count]=[count]-1 where [termid]={0}", oldPost.CategoryId));
            //}
        ...
        public PostInfo GetPost(int postid)
        {
            ...
            List<PostInfo> list = DataReaderToCommentList(SqlHelper.ExecuteReader(cmdText, prams));
        ...
        public List<PostInfo> GetPostList()
        {
            ...
            return DataReaderToCommentList(SqlHelper.ExecuteReader(cmdText));
        }
        ...
        public List<PostInfo> GetPostList (int pageSize, int pageIndex, out int recordCount,  int categoryId,int tagId, int userId,int recommend, int status, int topstatus,int hidestatus,string begindate,string enddate, string keyword)
        {
            ...
            recordCount = StringHelper.ObjectToInt(SqlHelper.ExecuteScalar(CommandType.Text, cmdTotalRecord));


            string cmdText = SqlHelper.GetPageSql("[Loachs_Posts]", "[PostId]", "*", pageSize, pageIndex, 1, condition);
        ...
        public int UpdatePostViewCount(int postId, int addCount)
        {
            ...
            SqlParameter[] prams = { 
								SqlHelper.MakeInParam("@addcount",SqlDbType.Int,4,addCount),
                                SqlHelper.MakeInParam("@postid",SqlDbType.Int,4,postId),
							};
            return SqlHelper.ExecuteNonQuery(CommandType.Text, cmdText, prams);
        }
