...
namespace daheng88.Data.MSSql
{
    public class Comment : IComment
    {
        ...
        public int InsertComment(CommentInfo comment)
        {
            ...
            SqlParameter[] prams = { 
                                        SqlHelper.MakeInParam("@PostId", SqlDbType.Int,4, comment.PostId),
                                        SqlHelper.MakeInParam("@ParentId", SqlDbType.Int,4, comment.ParentId),
                                        SqlHelper.MakeInParam("@UserId", SqlDbType.Int,4, comment.UserId),
                                        SqlHelper.MakeInParam("@Name", SqlDbType.VarChar,255, comment.Name),
                                        SqlHelper.MakeInParam("@Email", SqlDbType.VarChar,255, comment.Email),
                                        SqlHelper.MakeInParam("@SiteUrl", SqlDbType.VarChar,255, comment.SiteUrl),
                                        SqlHelper.MakeInParam("@Content", SqlDbType.VarChar,255, comment.Content),
                                        SqlHelper.MakeInParam("@EmailNotify", SqlDbType.Int,4 ,    comment.EmailNotify),
                                        SqlHelper.MakeInParam("@IpAddress", SqlDbType.VarChar,255, comment.IpAddress),
                                        SqlHelper.MakeInParam("@CreateDate", SqlDbType.DateTime,8, comment.CreateDate),
                                        SqlHelper.MakeInParam("@Approved", SqlDbType.Int,4 ,   comment.Approved),
            };
            SqlHelper.ExecuteNonQuery(CommandType.Text, cmdText, prams);

            int newId = Convert.ToInt32(SqlHelper.ExecuteScalar("select top 1 [CommentId] from [loachs_comments]  order by [CommentId] desc"));
            return newId;
        }
        ...
        public int UpdateComment(CommentInfo comment)
        {
            ...
            SqlParameter[] prams = { 
                                        ...
                                        SqlHelper.MakeInParam("@CreateDate", SqlDbType.DateTime,8, comment.CreateDate),
                                        SqlHelper.MakeInParam("@Approved", SqlDbType.Int,4 ,   comment.Approved),
                                        SqlHelper.MakeInParam("@CommentId", SqlDbType.Int,4, comment.CommentId),
        ...
        public CommentInfo GetComment(int commentId)
        {
            ...
            List<CommentInfo> list = DataReaderToCommentList(SqlHelper.ExecuteReader(cmdText, prams));
        ...
        public List<CommentInfo> GetCommentList(int pageSize, int pageIndex, out int totalRecord, int order, int userId, int postId, int parentId, int approved, int emailNotify, string keyword)
        {
            ...
            totalRecord = Convert.ToInt32(SqlHelper.ExecuteScalar(CommandType.Text, cmdTotalRecord));

            //   throw new Exception(cmdTotalRecord);

            string cmdText = SqlHelper.GetPageSql("[loachs_comments]", "[CommentId]", "*", pageSize, pageIndex, order, condition);
        ...
        public int GetCommentCount(int userId, int postId, bool incChild)
        {
            ...
            return Convert.ToInt32(SqlHelper.ExecuteScalar(CommandType.Text, cmdText));
        }
    }
}
